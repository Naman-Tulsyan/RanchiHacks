...
import {
    Shield, LogOut, Home, FileCheck, User,
    Menu, X
} from 'lucide-react';
...
export default function MainLayout() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
                ...
                <div className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/" className="flex items-center gap-2">
                            ...
                            <span className="text-white font-semibold hidden sm:block">Evidence Chain</span>
                        </Link>
                    </div>
            ...
            <div className="flex">
                {/* Sidebar - Desktop */}
                <aside className="hidden lg:block w-64 min-h-[calc(100vh-57px)] bg-slate-900/50 border-r border-slate-800 p-4">
